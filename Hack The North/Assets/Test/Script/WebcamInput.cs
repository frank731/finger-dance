...
public sealed class WebcamInput : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _buffer = new RenderTexture(_resolution.x, _resolution.y, 0);
            _webcam.wrapMode = TextureWrapMode.MirrorOnce;
        _webcam.Play();
    }
    ...
    void Update()
    {
        ...
        var temp = RenderTexture.GetTemporary(_buffer.descriptor);
        Graphics.Blit(_buffer, temp, new Vector2(-1, 1), new Vector2(1, 0));
